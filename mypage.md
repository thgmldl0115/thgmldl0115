...
**14일 :** &nbsp; SQLD 접수
> 오전 : 스프링 채팅 구현 <br>
> 오후 : 머신러닝 이미지 분류. <br> flask 기초 (추후 점검 필요) <br>
> 독서 : 채식주의자(2/3)

> 센서 부품 추가구매 결정_ 완료 <br>

**15일 :**
> 오전 : 단체 채팅 구현 + 채팅시 프로필 이미지 뜨도록<br>
> 오후 : flask로 '머신러닝 숫자 분류기' 웹페이지 만들기, 추천 시스템
> 독서 : 체식주의자 완독

> 기획서 추진배경, 개발 목표 및 내용 작성

**16일 :** &nbsp; 해커톤 2차 옵션 연락, 파일 전송
> 오전 : 메일 기능 구현, 프로젝트 github에 업로드 <br>
> 오후: 비동기연결 사용하여 Flask - Spring 설문 페이지 개설

> 핵심 기능 알고리즘, 동작 다이어그램_완료<br>
> TAM SAM SOM 측정_완료<br>
> 개발추진체계 간트차트 작성_완료

**17일 :** &nbsp; 23:00 해커톤 2차 멘토링
> 오전 : 웹사이트 오류 발생시 modal 띄우기, validation 설정. <br>
> 오후 : 코딩테스트 1차 재응시 및 개인프로젝트 정비

> 기획서 수정 완료하여 메일 전송. 멘토링 전 자가채점 실시.<br>
> 개인프로젝트용 DB설계.
...
**28일 :** &nbsp; 해커톤 예선 과제 제출 (~17:00)
- 최종 피드백 반영하여 제출_완료
- 자소서 작성

**29일 :** &nbsp; 10:00 프로젝트 발표 참관
- 공유폴더에서 프로젝트 받아서 임포트
- 스프링부트 시작
- 비지도학습
...
- 행정실에 입사지원서 문의_ 완료
- React Native설치_1/2
- sqld (~386p) 2회독, 기출변형 모의고사 3,4,5회차 풀이**23일 :**
- diary 이미지 저장 (화면캡쳐)
- 아두이노 <-> 파이썬 연결
- 데이터 간이 수집 및 db저장
- 오라클 <-> 파이썬 연결하여 db조회 및 그래프 생성
...
- 행정실에 입사지원서 문의_ 완료
- React Native설치_1/2
- sqld (~386p) 2회독, 기출변형 모의고사 3,4,5회차 풀이
